...
import FilesDetailSection from './components/files-detail-section';
import OperationsDetailSection from './components/operations-detail-section';
            ...
            <div className="row">
                <div className="col-md-12">
                    <div className="well well-sm">
                        ...
                        <FilesDetailSection data={this.state.files}/>
                        <OperationsDetailSection data={this.state.operations}/>
                    </div>
                </div>
            </div>
        );
